 ...
 * Esta clase es la XNOR, la cual es una clase hija de compuerta logica, encargada del funcionamiento de la compuerta XNOR
...
public class XNOR extends Compuerta_Logica{
     ...
     * Constructor para la compuerta XNOR
